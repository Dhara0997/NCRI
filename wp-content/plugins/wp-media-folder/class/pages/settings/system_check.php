...
<div class="content-box wpmf_width_80">
    ...
    <div class="wpmf_width_100 p-tb-20 wpmf_left">
        <h2><?php esc_html_e('Plugin license and live updates', 'wpmf'); ?></h2>
        <button class="button button-primary ju-btn-disconnect"><?php esc_html_e('Disconnect my Joomunited license', 'wpmf') ?></button>
    </div>
