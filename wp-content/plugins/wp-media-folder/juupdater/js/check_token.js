                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.status === true) {
                            ...
                            var link = updaterWPMFparams.ju_base + "index.php?option=com_juupdater&view=connect&ext_name="+slug+"&tmpl=component&site=" + updaterWPMFparams.site_url + "&TB_iframe=true&width=600&height=550";
